    ...
    console.log(password);
        ...
        if(email == "sayadosen@amikom.ac.id" && password =="amikom"){
            window.location.href="../Dosen/listKelas.html"
        }else {
    ...
    const kelasData = [
        ...
        },
        {
            ...
            angkatan : "2025 - Ganjil",
            nama: "SI07 - TUGAS PROYEK UI.UX"
        },
        {
            color: "rgba(215, 245, 81, 0.6)",
            angkatan : "2024 - Genap",
            nama: "SI03 - REKAYASA PERANGKAT LUNAK"
        },
        {
            color: "rgba(3, 171, 110, 0.6)",
            angkatan : "2024 - Genap",
            nama: "SI06 - REKAYASA PERANGKAT LUNAK"
        },
        {
            color: "rgba(14, 3, 171, 0.6)",
            angkatan : "2024 - Genap",
            nama: "SI07 - REKAYASA PERANGKAT LUNAK"
        }
        ...
        kelasData.forEach((kelas)=>{
            ...
            div.innerHTML = `
                <div class="cards" style="background-image: url(assets/tekstur.jpg); background-position: center; background-size: cover; overflow: hidden;">
                    ...
                    <a href="" class="backCard" style="z-index: 99;"></a>
                </div>
            `;
